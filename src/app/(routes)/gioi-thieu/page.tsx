...
const GioithieuPage: React.FC = () => {
  return (
    <div className="container mx-auto bg-white text-gray-800">
      {/* Hero section */}
      ...
      <section className="py-12 px-6 md:px-16 grid md:grid-cols-2 gap-10 items-center">
        <div className="space-y-6">
          <h2 className="text-2xl font-semibold text-gray-800">Về chúng tôi</h2>
          <p className="text-gray-600 leading-relaxed">
            Guitar Sài Thành được thành lập với sứ mệnh mang đến cho cộng đồng
            yêu âm nhạc tại Việt Nam những sản phẩm chất lượng, giá cả hợp lý và
            dịch vụ tận tâm.
          </p>
          <p className="text-gray-600 leading-relaxed">
            Chúng tôi không chỉ là nơi bán nhạc cụ, mà còn là nơi kết nối, chia
            sẻ và lan tỏa đam mê âm nhạc thông qua các buổi workshop, lớp học
            guitar và cộng đồng người chơi nhạc.
          </p>
        </div>

        <div className="w-full rounded-2xl overflow-hidden shadow-lg">
          <img
            src="/images/store-guitar.jpg"
      ...
      <section className="bg-gray-50 py-12 px-6 md:px-16 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-gray-700">
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
            ...
            <p className="text-sm">
              Đảm bảo 100% hàng chính hãng từ các thương hiệu uy tín như Yamaha,
              Fender, Cordoba,...
            </p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
