...
export const Footer: FC = () => {
  return (
    <footer className="bg-gradient-to-b from-cyan-500 to-pink-100 text-gray-800 pt-12 pb-8">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {/* Giới thiệu */}
          <div className="space-y-5">
            <h2 className="text-xl sm:text-2xl font-semibold text-white uppercase border-b-2 border-white inline-block pb-1 tracking-wide">
              Nội thất EcoHome
            </h2>
            <p className="text-sm sm:text-base leading-relaxed font-light max-w-prose">
          ...
          {/* Hỗ trợ khách hàng */}
          <div className="space-y-5">
            <h2 className="text-lg sm:text-xl font-semibold text-white uppercase border-b-2 border-white inline-block pb-1 tracking-wide">
              Hỗ trợ khách hàng
            </h2>
          ...
          <div className="space-y-5">
            ...
            <ul className="space-y-3 text-sm sm:text-base">
              ...
              <li className="flex items-start gap-3">
                <Phone className="text-white w-5 h-5 mt-1 shrink-0" />
        ...
        {/* Footer Bottom */}
        <div className="mt-10 border-t border-neutral-600 pt-6 text-center text-xs sm:text-sm text-neutral-400">
